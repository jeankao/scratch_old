...
urlpatterns = [
    # post views
    #url(r'^$', 'certificate.views.upload_pic'),   
    #url(r'^show/(?P<unit>\d+)/(?P<enroll_id>\d+)/$', 'certificate.views.show'),   
    #url(r'^image/(?P<unit>\d+)/(?P<enroll_id>\d+)/(?P<teacher_id>\d+)/$', 'certificate.views.make_image'),   
    #url(r'^classroom/(?P<unit>\d+)/(?P<classroom_id>\d+)/$', 'certificate.views.classroom'),   
